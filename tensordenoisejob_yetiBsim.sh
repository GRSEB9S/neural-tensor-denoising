...
#Run Matlab
matlab -nosplash -nodisplay -nodesktop -r "tensorDenoiseClusterBsim($PBS_ARRAYID)" > /vega/zmbbi/users/jss2219/TensorDenoising/mat-outfile/matoutfile$PBS_ARRAYID
