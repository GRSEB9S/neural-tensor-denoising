...
#Run Matlab
matlab -nosplash -nodisplay -nodesktop -r "tensorDenoiseClusterAsim($PBS_ARRAYID)" > /vega/zmbbi/users/jss2219/TensorDenoising/mat-outfile/matoutfile$PBS_ARRAYID
